...
# Following lines of code can be used to load the xlsb file
# install.packages("RODBC")
# library(RODBC)
# wb <- "WC_Data_Science Case Study.xlsb" # Give the file name
# con3 <- odbcConnectExcel2007(wb)
# data <- sqlFetch(con3, "Data$") # Provide name of sheet
# nrow(data)
